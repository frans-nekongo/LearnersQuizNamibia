...
interface SectionCProps {/*change this when section move*/
    selectedSet?: string
...
export default function SectionC({selectedSet, onScoreChange}: SectionCProps) {/*change this when section move*/
    ...
    useEffect(() => {
        const fetchPosts = async () => {
            let {data: table_name, error} = await supabase
                ...
                .eq('section_text', 'SECTION C – RULES – ALL CODES')//change this wehn section move
