...
interface SectionEProps {/*change this when section move*/
    selectedSet?: string
...
export default function SectionE({selectedSet, onScoreChange}: SectionEProps) {/*change this when section move*/
    ...
    useEffect(() => {
        const fetchPosts = async () => {
            let {data: table_name, error} = await supabase
                ...
                .eq('section_text', 'SECTION E – LIGHT AND HEAVY VEHICLES ONLY')//change this wehn section move
